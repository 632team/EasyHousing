            ...
            <table class="table table-striped table-bordered table-hover dataTable no-footer" id="sample-table"
              ...
              <tr role="row" class="odd">
                ...
                <td class="td-manage">
                  ...
                  <a id=<%=irentHouse.getRentHouseId() %> title="通过" href="javascript:;" class="btn btn-xs btn-info" onclick="member_edit(this,this.parentNode.parentNode.cells[1].innerHTML,this.id)">通过</a>

                  <a id=<%=irentHouse.getRentHouseId() %> title="不通过" href="javascript:;" class="btn btn-xs btn-warning" onclick="member_del(this, this.parentNode.parentNode.cells[1].innerHTML,this.id)">不通过</a>
                </td>
              </tr>
              <%
              }
...
<script>
  ...
  /*用户-编辑*/
  function member_edit(obj,id, okRentHouseId){
	  layer.confirm('确认要通过吗？',function(index){
		  $(obj).parents("tr").remove();
	      setCookie("okRentHouseId",okRentHouseId,365);
	      transpDel1();
  ...
  /*用户-删除*/
  function member_del(obj,id, noRentHouseId){
    layer.confirm('确认要拒绝吗？',function(index){
      $(obj).parents("tr").remove();
      
      setCookie("noRentHouseId",noRentHouseId,365);
      transpDel();
