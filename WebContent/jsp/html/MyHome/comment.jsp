...
<head>
  ...
  <style>
    ...
    .colorFillLabel.yangtai {
      background: #00ae66
    }

    .colorFillLabel.weishengjian {
      background: #F1B541
    }
    ...
    <div class="user-main">
      <div class="main-left fl">
        <ul class="nav nav-pills nav-stacked">
          ...
          <li role="presentation" class="active"><a href=${pageContext.request.contextPath}/jsp/html/MyHome/comment.jsp>我的评论</a></li>
